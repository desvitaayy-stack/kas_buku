                ...
                <form action="pemasukan/create" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" rows="10" name="keterangan" class="form-control" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label>Tanggal</label>
    ...
    <div class="modal fade" id="edit{{ $item->id_keuangan }}" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Edit pemasukan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <!-- Modal Body -->
                <form action="pemasukan/{{ $item->id_keuangan }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <!-- Form bisa ditempatkan di sini -->
                        ...
                        <div class="mb-3">
                            <label>Keterangan *</label>
                            <textarea name="keterangan" rows="10" class="form-control" required>{{ $item->keterangan }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label>Tanggal</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="pemasukan/{{ $item->id_keuangan }}" method="post">
                    ...
                    <div class="modal-body">
                        <!-- Form bisa ditempatkan di sini -->
                        Yakin ingin menghapus pemasukan "{{ $item->keterangan }}" dengan nominal Rp {{ number_format($item->nominal, 0, ',', '.') }}?
                    </div>
